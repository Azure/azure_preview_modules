...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabscustomimage_facts
version_added: "2.8"
short_description: Get Azure Custom Image facts.
description:
    - Get facts of Azure Custom Image.
...
EXAMPLES = '''
  - name: Get instance of Custom Image
    azure_rm_devtestlabscustomimage_facts:
