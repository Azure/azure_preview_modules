...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsservicerunner_facts
version_added: "2.8"
short_description: Get Azure Service Runner facts.
description:
    - Get facts of Azure Service Runner.
...
RETURN = '''
service_runners:
    description: A list of dictionaries containing facts for Service Runner.
    returned: always
    type: complex
    contains:
        id:
...
class AzureRMServiceRunnersFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['service_runners'] = self.get()
        return self.results
