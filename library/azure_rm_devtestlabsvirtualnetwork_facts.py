...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsvirtualnetwork_facts
version_added: "2.8"
short_description: Get Azure Virtual Network facts.
description:
    - Get facts of Azure Virtual Network.
...
RETURN = '''
virtual_networks:
    description: A list of dictionaries containing facts for Virtual Network.
    returned: always
    type: complex
    contains:
        id:
