...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsarmtemplate_facts
version_added: "2.8"
...
class AzureRMArmTemplatesFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.expand = None
        self.tags = None
        super(AzureRMArmTemplatesFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for ArmTemplates.')
