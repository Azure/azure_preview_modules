...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsuser_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of User
    azure_rm_devtestlabsuser_facts:
...
class AzureRMUsersFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.expand = None
        self.tags = None
        super(AzureRMUsersFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Users.')
