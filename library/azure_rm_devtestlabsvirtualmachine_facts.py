...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsvirtualmachine_facts
version_added: "2.8"
...
class AzureRMVirtualMachinesFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.expand = None
        self.tags = None
        super(AzureRMVirtualMachinesFacts, self).__init__(self.module_arg_spec, supports_tags=False)
