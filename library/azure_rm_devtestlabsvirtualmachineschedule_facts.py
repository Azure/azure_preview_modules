...
DOCUMENTATION = '''
---
module: azure_rm_devtestlabsvirtualmachineschedule_facts
version_added: "2.8"
short_description: Get Azure Virtual Machine Schedule facts.
description:
    - Get facts of Azure Virtual Machine Schedule.
...
EXAMPLES = '''
  - name: Get instance of Virtual Machine Schedule
...
virtual_machine_schedules:
    description: A list of dictionaries containing facts for Virtual Machine Schedule.
    returned: always
    type: complex
    contains:
        id:
...
class AzureRMVirtualMachineSchedulesFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['virtual_machine_schedules'] = self.get()
        return self.results
